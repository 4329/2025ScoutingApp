	...
	return (
		<>
			<section className="scroll-mt-6" id="auto">
				<h2>Auto</h2>
				<CoolSwitch className="p-10" id="auto_leave" title="Leave" initial={initialStates["leave"]} />
				<Coralinator title="Auto Coral" type="auto" />	
			...
			<section className="scroll-mt-6" id="teleop">
				<h2>Teleop</h2>
				<Coralinator title="Teleop Coral" type="teleop" />	
